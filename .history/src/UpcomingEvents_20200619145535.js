...
class EventSection extends Component {
    ...
    render(){
        const noEventsMessage = "We're sorry, there are no events scheduled at this time. Check back regularly as we add "
            ...
            return(
                ...
                <Container className="pt-2 px-5">
                    ...
                    <Row className="justify-content-between pb-3">
                        ...
                        <Col sm={12} lg={7}>
                            <p className="lead" style={{fontSize: "1.2rem"}}>{noEventsMessage}</p>
                        </Col> 
                    </Row>
                </Container>
            </>
