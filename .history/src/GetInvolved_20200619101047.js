...
const GetInvolved extends Component{
           ...
           <div id="getInvolved" className="bg-light">
               <Container className="text-center">
                ...
                <Row className="pt-5 mx-5">
                    ...
                    <Blurb icon={PlanIcon} cardTitle="Present with us" cardText={card3} class="card3" buttonText="Send us Your Idea" href={presenterForm}/>
                </Row>
           </div>
        );
    }
