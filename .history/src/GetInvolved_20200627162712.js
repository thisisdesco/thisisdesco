...
import PartnerIcon from './images/partnerships.png'
           ...
           <div id="getInvolved" className="bg-light">
               <Container className="text-center">
                ...
                <Row className="pt-5 mx-5">
                    ...
                    <Blurb icon={BookIcon} alt="Partnerships Icon" cardTitle="Partnerships" cardText={card2} class="card2" buttonText="Send us a proposal" href={partnershipForm}/>
