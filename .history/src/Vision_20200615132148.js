...
const Vision = () => {
    ...
    const whatWeDo = "Our mission is to serve as a network for fostering awareness, connection, and inspiration in the design community. We meet monthly (in person) to discuss design and its related topics in a safe and inclusive environment. For those that can’t join us in person, we also have online spaces where people of all skill levels can collaborate, exchange ideas, learn, receive feedback, maintain accountability, and network."
    return(
