    ...
    <Container fluid className="bg-custom">
        <Row className="pt-4 mx-5 d-lg-flex d-sm-block justify-content-center">
            ...
            <Col sm={4} lg={3} className="text-white ml-5 mr-0 pb-4">
                ...
                <a href="https://www.facebook.com/sacdesco" target="_blank"><Image src={fbIcon} alt="facebook icon" /></a>
                <a href="https://www.instagram.com/sacdesco/" target="_blank"><Image src={igIcon} alt="instagram icon" /></a>
                <a href="https://www.linkedin.com/company/sacdesco" target="_blank"><Image src={linkedinIcon} alt="linkedin icon" /></a>
