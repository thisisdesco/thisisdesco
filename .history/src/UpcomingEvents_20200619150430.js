...
class EventSection extends Component {
    ...
    render(){
        ...
        const message2 = "If you would like to present with us or your organization would like to partner with us, check out the section below to see how!"
        if(this.state.upcomingEvents.length == 0){
            ...
            return(
                ...
                <Container className="pt-2 px-5 mb-0">
                    <h1 className="display-4 section-title mb-2">Upcoming Events</h1>
                    <Row className="justify-content-between pb-3">
                        ...
                        <Col sm={12} lg={7}>
                            <p className="lead my-5" style={{fontSize: "1.2rem"}}>{noEventsMessage} <br/><br/> {message2}</p>
                        </Col> 
                    </Row>
                </Container>
            </>
