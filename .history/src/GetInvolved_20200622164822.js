           ...
           <div id="getInvolved" className="bg-light">
               <Container className="text-center">
                ...
                <Row className="pt-5 mx-5">
                    ...
                    <Blurb icon={BookIcon} alt="Partnerships Icon" cardTitle="Partnerships" cardText={card2} class="card2" buttonText="Send a proposal" href={partnershipForm}/>
                    <Blurb icon={PlanIcon} alt="Present" cardTitle="Present with us" cardText={card3} class="card3" buttonText="Send us Your Idea" href={presenterForm}/>
                </Row>
           </div>
        );
}
