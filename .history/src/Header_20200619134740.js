...
const ContactForm = () => {
    ...
    const submitForm = (e) => {
        ...
        emailjs.send(
            ...
            dislcaimer = 'Uh oh, it looks like something went wrong. You can also reach us at thisisdesco@gmail.com.com'
        })
        setTimeout(()=>{setButtonText('Success!')}, 500);
        setTimeout(()=>{setButtonText('Send it!')}, 10000)
    }
    ...
    return(
        ...
        <Col>
                ...
                <br/>
                <Button type="submit" variant="outline-info" onClick={submitForm}>{buttonText}</Button>
