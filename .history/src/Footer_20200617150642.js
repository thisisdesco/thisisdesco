    ...
    <Container fluid className="bg-custom">
        <Row className="pt-4 mx-5 d-lg-flex d-sm-block justify-content-center">
            ...
            <Col sm={6} lg={4} className="mr-5">
                ...
                <label htm-for="email">Email</label>
                <input type="text" id="email" className="form-control" placeholder="yourname@example.com"></input>
                <TextareaAutosize className="form-control" placeholder="Type your message here."></TextareaAutosize>
                <br/>
