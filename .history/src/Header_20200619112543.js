...
const ContactForm = () => {
    ...
    const disclaimer = "* DESCO respects your privacy and will never share your information without your permission."
    ...
    const submitForm = () => console.log(email, message, name)
