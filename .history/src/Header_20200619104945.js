...
const ContactForm = () => {
    ...
    return(
        <InputGroup>
        <Col>
                <p className="lead footer-text">{footerText}</p>
                <input type="text" id="email" className="form-control" placeholder="Email" required></input>
                <TextareaAutosize className="form-control text-area" placeholder="Your Message" required></TextareaAutosize>
                <br/>
                <input type="submit" value="Send it!" className="outline-info"></input>
                <Button variant="outline-info" type="submit">Send it!</Button>
