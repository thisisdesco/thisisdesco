...
import slackIcon from './slack_icon.svg'
    ...
    <Container fluid className="bg-custom">
        <Row className="pt-4 mx-5 d-lg-flex d-sm-block justify-content-center">
            ...
            <Col sm={4} lg={3} className="text-white ml-5 mr-0 pb-4">
                ...
                <a href="https://www.instagram.com/sacdesco/" target="_blank"><Image src="./images/ig_icon.svg" alt="instagram icon"></a>
                <a href="https://www.linkedin.com/company/sacdesco" target="_blank"><Image src="./images/linkedin_icon.svg" alt="linkedin icon"></a>
                <a href="https://sac-desco.slack.com" target="_blank"><Image src="./images/slack_icon.svg" alt="slack icon"></a>
