...
const ContactForm = () => {
    ...
    return(
        ...
        <Col>
                ...
                <input type="text" id="email" className="form-control" placeholder="Email" onChange={this.handleSetEmail} required></input>
                <TextareaAutosize className="form-control text-area" placeholder="Your Message" required></TextareaAutosize>
                <br/>
                <Button type="submit" variant="outline-info" onClick={validateForm}>Send it!</Button>
