...
const Sponsors = () => {
    return(
        <Container fluid>
            <Row>
                <h1>Sponsors</h1>
                <img src={rosevilleUX} alt="rosevilleUX logo" className="sponsor-logo" />
                <img src={designSac} alt="designSac logo" className="sponsor-logo" />
                <img src={cPlus} alt="creativity plus logo" className="sponsor-logo" />
            </Row>
        </Container>
    );
}
