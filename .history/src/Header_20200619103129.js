...
const ContactForm = () => {
    ...
    return(
        <Col>
                ...
                <input type="text" id="email" className="form-control" placeholder="Email" required="true"></input>
                <TextareaAutosize className="form-control text-area" placeholder="Your Message" required="true"></TextareaAutosize>
                <br/>
                <Button variant="outline-info">Send it!</Button>
