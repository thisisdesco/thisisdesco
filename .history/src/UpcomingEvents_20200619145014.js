...
import values_illustration from './images/events_illustration.png' //need to load not found
        ...
        if(this.state.upcomingEvents.length == 0){
            ...
            return(
                ...
                <Container id="events" className="pt-2 px-5">
                    ...
                    <p className="lead"> We're sorry, there are no upcoming events at this time. Check back as we update regularly.</p>
                </Container>
            </>
            )
        }
