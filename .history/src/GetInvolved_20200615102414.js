...
class GetInvolved extends Component{
    ...
    render(){ 
        ...
        // DONATE CARD
        const card2 = {"Have an idea for an event or workshop? Want to partner with us? ", className="card-extra-padding"};
        // SPONSOR CARD
           ...
           <div id="getInvolved" className="bg-light">
               <Container className="text-center">
                ...
                <Row className="pt-5 mx-5">
                    ...
                    <Blurb icon={BookIcon} cardTitle="Partnerships" cardText={card2}/>
