...
class EventSection extends Component {
    ...
    render(){
        const noEventsMessage = "We're sorry, there are no events scheduled at this time. Check back regularly as we're always working on new ideas. If you would like to present with us or your organization would like to partner with us or present with us, check out the section below to see how!"
            ...
            return(
                ...
                <Container className="pt-2 px-5 mb-0">
                    ...
                    <Row className="justify-content-between pb-3">
                        ...
                        <Col sm={12} lg={7}>
                            <p className="lead my-5" style={{fontSize: "1.2rem"}}>{noEventsMessage}</p>
                        </Col> 
                    </Row>
                </Container>
            </>
