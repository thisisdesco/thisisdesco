        ...
        <Row className="pt-4 mx-5 d-lg-flex d-sm-block justify-content-center">
            ...
            <Col sm={4} lg={3} className="text-white ml-5 mr-0 pb-4">
                ...
                <Container className="pl-0">
                    ...
                    <a href="#about" className="linkfont text-white">Sponsor</a> <br>
                    <a href="#about" className="linkfont text-white">Volunteer</a><br>
                    <a href="#about" className="linkfont text-white">Donate</a><br>
