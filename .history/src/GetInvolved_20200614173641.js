...
class GetInvolved extends Component{
    ...
    render(){ 
        ...
        // VOLUNTEER CARD
        const card1 = "DESCO is run by volunteers who are passionate about growing Sacramento's design community. All events are made possible by the generous donations from our team and community. Check out the link below to see how you can contribute!";
        // DONATE CARD
