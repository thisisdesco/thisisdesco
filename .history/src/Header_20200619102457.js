...
const ContactForm = () => {
    ...
    return(
        <Col sm={6} lg={4} className="mr-5">
                ...
                <input type="text" id="email" className="form-control modal" placeholder="Email"></input>
                <TextareaAutosize className="form-control text-area modal" placeholder="Your Message"></TextareaAutosize>
                <br/>
