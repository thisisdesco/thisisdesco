...
import placeHolder from 'https://firebasestorage.googleapis.com/v0/b/desco-site-eb-integration.appspot.com/o/images%2FDESCO-Logo-notext.png?alt=media'
    ...
    componentDidMount(){
        ...
        db.collection("events").get().then((results) =>{ 
            results.forEach((res) => {
                ...
                let placeHolder = "imagesRef.child('DESCOhttps://firebasestorage.googleapis.com/v0/b/desco-site-eb-integration.appspot.com/o/images%2FDESCO-Logo-notext.png?alt=media-Logo-notext.png')";
