...
const Vision = () => {
    const ourVision = "DESCO envisions an educational design community in Sacramento for people from all backgrounds, fields, and skill levels. We value transparency,";
    return(
