            ...
            <>
                <Container className="pt-2 px-5">
                    ...
                    {this.state.events.map((e, i) => {
                        return(
                            <>
                                <Event date={e.date} title={e.title} speaker={e.speakerName} description={e.description} ticketLink={e.ticketLink} eventImage={e.image}/>
                                {i < (this.state.events.length - 1) && <hr className="mt-5 pb-3" />}
                            </>
                        );
                        })}
                </Container>
