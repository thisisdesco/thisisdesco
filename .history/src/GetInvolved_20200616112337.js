           ...
           <div id="getInvolved" className="bg-light">
               <Container className="text-center">
                ...
                <Row className="pt-5 mx-5">
                    <Blurb icon={ChatIcon} cardTitle="Volunteer" cardText={card1} buttonText="Join the Team"/>
                    <Blurb icon={BookIcon} cardTitle="Partnerships" cardText={card2} class="card2" buttonText="Partner with us"/>
                    <Blurb icon={PlanIcon} cardTitle="Present with us" cardText={card3} class="card3"/>
                </Row>
           </div>
        );
    }
