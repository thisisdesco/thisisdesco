        ...
        <Col lg={4} md={12}>
            <Card border="light" className="bg-light text-center px-3">  
                ...
                <Card.Body className="card-body pb-5">
                    ...
                    <Button variant="outline-info" className="mt-3" href={props.href} target="-blank">{props.buttonText}</Button>
                </Card.Body>
            </Card>
        </Col>
    );
           ...
           <div id="getInvolved" className="bg-light">
               <Container className="text-center">
                ...
                <Row className="pt-5 mx-5">
                    <Blurb icon={ChatIcon} cardTitle="Volunteer" cardText={card1} buttonText="Join our Team" href={volunteerForm}/>
                    <Blurb icon={BookIcon} cardTitle="Partnerships" cardText={card2} class="card2" buttonText="Partner with us" href={partnershipForm}/>
                    <Blurb icon={PlanIcon} cardTitle="Present with us" cardText={card3} class="card3" buttonText="Contact us" href=""/>
                </Row>
           </div>
        );
    }
