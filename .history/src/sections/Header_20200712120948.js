        ...
        return(
            ...
            <Jumbotron fluid>
                <Container className="text-md-center text-lg-left py-5 my-custom headline-container" style={headlineContainer}>
                    ...
                    <Link to="getInvolved" spy={true} smooth={true} offset={-70} duration={500} className="btn btn-info text-white"><Button href="#getInvolved" variant="info">Get Involved</Button></Link>
