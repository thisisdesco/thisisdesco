        ...
        <Container>
            ...
            <Navbar.Collapse id="responsive-navbar-nav ml-auto">
                <Nav className="ml-auto nav-center">
                    <Link activeClass="active" className="linkfont text-white " to="events" spy={true} smooth={true} offset={-70} duration={500}>Events</Link>
                    <Link activeClass="active" className="linkfont text-white" to="about" spy={true} smooth={true} offset={-70} duration={500}>About</Link>
