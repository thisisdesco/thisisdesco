...
const NavigationBar = () => {
        ...
        return(
        <Container>
            <Navbar collapseOnSelect expand="lg" variant="outline-light" bg="custom">
...
class Header extends Component {
    render(){
        ...
        return(
            ...
            <NavigationBar />
            {/* Jumbotron */}
                <Row className="px-auto jumbotron justify-content-center">
                <Col md={5}>
                    <img
                        src={HeaderImage}
                ...
                <Col className="text-left py-5 my-auto headline-container"  lg={4} md={4}>
                    <p className="jumbo-text">DESCO is An Educational Design Community in Sacramento for All Backgrounds</p>
