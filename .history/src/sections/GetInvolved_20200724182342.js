        ...
        <Col lg={4} md={12}>
            <Card border="light" className="bg-light text-center px-3">  
                ...
                <Card.Body className="card-body pb-5">
                    ...
                    <Button variant="outline-info" className="mt-3 align-self-end" href={props.href} target="_blank">{props.buttonText}</Button>
                </Card.Body>
            </Card>
        </Col>
    );
...
const GetInvolved = () => {
        ...
        <Container fluid className="bg-light">
           <Container id="getInvolved" className="bg-light">
               <Container className="text-center">
                ...
                <Row className="pt-5 mx-5">
                    ...
                    <Blurb icon={PartnerIcon} alt="Partnerships Icon" cardTitle="Partnerships" cardText={card2}  buttonText="Send us a proposal" href={partnershipForm}/>
