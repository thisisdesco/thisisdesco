        ...
        <Container>
            ...
            <Navbar.Collapse id="responsive-navbar-nav ml-auto">
                <Nav className="ml-auto nav-center">
                    <Link to="events" className="linkfont" spy={true} smooth={true} offset={-70} duration={500}>Events</Link>
                    ...
                    <Link to="getInvolved" spy={true} smooth={true} offset={-70} duration={500}>Get Involved</Link>
