...
class Header extends Component {
    render(){
        ...
        return(
            ...
            {/* Jumbotron */}
            <Container>
                <div className="px-auto header-container">
                    <div >
                        <img
                            src={HeaderImage}
                            className="header-image header-image-container"
                            alt="images of DESCO events"
                        />
                    </div>
                    
                    <div className="text-left py-5 my-auto headline-text-container">
                        <p className="jumbo-text">DESCO is An Educational Design Community in Sacramento</p>
                        <div to="getInvolved" spy={true} smooth={true} offset={-70} duration={500}><Button href="#getInvolved" variant="info">Get Involved</Button></Link>
                    </Col>
                </div>
            </Container>
            </div>
