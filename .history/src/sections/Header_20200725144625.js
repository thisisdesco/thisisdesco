...
class Header extends Component {
    render(){
        ...
        return(
            ...
            {/* Jumbotron */}
            <Container>
                <Row className="px-auto d-flex align-items-center header-container">
                <Col md={8}>
                    <img
                        src={HeaderImage}
                        className="header-image flex-fill"
                        alt="images of DESCO events"
                    />
                </Col>
                
                <Col className="text-left py-5 my-auto headline-text-container"  lg={4} md={8} sm={12}>
