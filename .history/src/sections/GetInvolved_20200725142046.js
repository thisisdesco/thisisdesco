        ...
        <Col lg={4} md={12}>
            <Card border="light" className="bg-light text-center px-3">  
                <img
                    ...
                    alt={props.alt}
                />
                <Card.Body className="card-body pb-3 d-flex flex-column justify-content-between">
                    <h4>{props.cardTitle}</h4>
                    <Card.Text>
                        {props.cardText}
                    </Card.Text>
                    <Button variant="outline-info" className="mt-3 align-self-center" href={props.href} target="_blank">{props.buttonText}</Button>
                </Card.Body>
            </Card>
        </Col>
    );
